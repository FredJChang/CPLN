...
class DenseNet121(nn.Module):
    ...
    """
    def __init__(self, out_size, mode, drop_rate=0, in_channels=3, pretrained=True):
        super(DenseNet121, self).__init__()
        assert mode in ('U-Ones', 'U-Zeros', 'U-MultiClass')
        self.densenet121 = DenseNet.densenet121(pretrained=pretrained, drop_rate=drop_rate, in_channels=in_channels)
...
class DenseNet161(nn.Module):
    ...
    def __init__(self, out_size, mode, drop_rate=0, in_channels=3, pretrained=True):
        ...
        assert mode in ('U-Ones', 'U-Zeros', 'U-MultiClass')
        self.densenet161 = DenseNet.densenet161(pretrained=pretrained, drop_rate=drop_rate, in_channels=in_channels)
...
class DenseNet201(nn.Module):
    ...
    def __init__(self, out_size, mode, drop_rate=0, in_channels=3, pretrained=True):
        ...
        assert mode in ('U-Ones', 'U-Zeros', 'U-MultiClass')
        self.densenet201 = DenseNet.densenet201(pretrained=pretrained, drop_rate=drop_rate, in_channels=in_channels)
